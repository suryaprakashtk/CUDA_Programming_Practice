...
int main(int argc, char** argv) {
    int NO_THREADS_PER_BLOCK_X = 16;
    int NO_THREADS_PER_BLOCK_Y = 16;
    ...
    run_kernel(input0.data(), input1.data(), output_gpu.data(), input0_dim, input1_dim, NO_THREADS_PER_BLOCK_X, NO_THREADS_PER_BLOCK_Y);
